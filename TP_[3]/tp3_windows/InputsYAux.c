 ...
 * @param cadena La cadena de caracteres que se ingresa
 * @param mensaje El mensaje que se muestra al usuario
 * @param tam El tamanio de la cadena de caracteres ingresada
 * @param pNumeroValidado El valor validado y convertido en flotante
 * @return Retorna 0 si no pudo cumplir su funcion y 1 si pudo
 */
		...
		float *pNumeroValidado)
{
	...
	if (cadena != NULL && mensaje != NULL)
	{
		...
		for (i = 0; i < tam && auxiliarString[i] != '\0'; i++)
		{
			...
			{
				printf("Error. El ingreso debe contener numeros decimales: ");
				fflush(stdin);
				gets(auxiliarString);
 ...
 * @param mensaje El mensaje que se muestra al usuario
 * @param tam El tamanio de la cadena de caracteres ingresada
 * @param pNumeroValidado El valor validado y convertido en entero
 * @return Retorna 0 si no pudo cumplir su funcion y 1 si pudo
 */
...
int getStringSoloNumeros(char cadena[], char mensaje[], int tam)
{
	char auxiliarString[1000];
	int retorno;
	int i;
